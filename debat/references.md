...
|---|----------|--------|----------|---------------|
| 1 | Notification d'admission ARE — France Travail, 1er oct. 2024 | France Travail | Avocat (R1) | `admission-are-france-travail-oct-2024.md` |
| 2 | Avis de situation SIRENE — micro-entreprise (SIRET 820 352 235 00031) | INSEE | Avocat (R1) | `avis-situation-insee-micro-entreprise.md` |
| 3 | Déclaration CA micro-entreprise — novembre 2025 | URSSAF | Avocat (R1) | `declaration-ca-micro-entreprise-nov-2025.md` |
| 4 | Demande de rescrit fiscal du 11 fév. 2025 (DRFIP) | Beluga Paris | Avocat (R1) | `demande-rescrit-fiscal-drfip-2025-02.md` |
| 5 | Réponse DRFIP — réf. RI 2025-692, 4 août 2025 | DRFIP IdF | Avocat (R1) | `reponse-rescrit-fiscal-drfip-2025-08.md` |
| 6 | Réponse URSSAF Île-de-France — 30 juin 2025 | URSSAF IdF | Avocat (R1) | `reponse-rescrit-social-urssaf-2025.md` |
| 7 | Extrait Kbis Beluga Paris (à jour 24 fév. 2025) | Greffe Paris | Avocat (R1) | `kbis-beluga-paris-sas.md` |
| 8 | Mémento fiscal Beluga Paris | DGFiP | Avocat (R1) | `memento-fiscal-beluga-paris.md` |
| 9 | Question parlementaire n° 12673 (Bergantz, 3 fév. 2026) | Assemblée nationale | Avocat (R1) | `question-parlementaire-12673-bergantz.md` |

## Textes de loi cités

| Texte | Objet dans le débat |
|-------|---------------------|
| Art. L 80 B 1° LPF | Rescrit fiscal — prise de position formelle |
| Art. L 80 CB LPF | Second examen d'une demande de rescrit |
| Art. 239 bis AB CGI | Option IR pour les sociétés de capitaux |
| Art. 235 ter CGI | Prélèvement de solidarité (7,5 %) |
| Art. L. 136-6, I, f) CSS | CSG sur revenus du patrimoine — BIC/BNC/BA — clause d'exception |
| Art. L. 136-1-2 CSS | CSG sur les revenus de remplacement (dont ARE) |
| Art. L. 136-3 CSS | CSG sur les revenus des travailleurs non salariés non agricoles |
| Art. L. 131-6 CSS | Assiette des cotisations sociales des TNS |
| Art. L. 613-7 CSS | Régime micro-social simplifié |
| Art. L. 311-2 CSS | Affiliation obligatoire au régime général |
| Art. L. 311-3, 23° CSS | Affiliation des présidents de SAS au régime général |
| Art. L. 311-5 CSS | Maintien des droits pendant le chômage |
